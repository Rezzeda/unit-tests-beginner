import Sem_4.book.Book;
import Sem_4.book.BookRepository;
import Sem_4.book.BookService;


import Sem_4.book.InMemoryBookRepository;
...
public class BookServiceTest {
    ...
    public void testFindBookById() {
        Book book = new Book("1", "Сказки", "Пушкин");
    ...
    public void testFindAllBook() {
        ...
        Book book2 = new Book("2", "Война и мир", "Толстой");
